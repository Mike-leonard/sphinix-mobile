  ...
  return (
    <div className="flex-1 max-w-md w-full mx-auto px-4 py-16">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-8 shadow-sm">
        ...
        <p className="text-slate-600 dark:text-slate-400 mb-6">Sign in to your Sphinix Mobile account</p>
        ...
        <p className="mt-6 text-center text-sm text-slate-600 dark:text-slate-400">
          Don't have an account? <Link href="/register" className="text-brand-500 hover:underline">Register here</Link>
        </p>
      </div>
    </div>
  );
