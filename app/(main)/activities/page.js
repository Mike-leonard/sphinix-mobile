...
export default function ActivitiesPage() {
  return (
    <div className="flex-1 px-4 py-16 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full">
      <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">My Activities</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm">
          ...
          <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-1">Bookmarks</h2>
          <p className="text-slate-500 text-sm mb-4">Saved devices and blogs</p>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm">
          ...
          <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-1">Comments</h2>
          <p className="text-slate-500 text-sm mb-4">Thoughts on our blogs</p>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm">
          ...
          <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-1">Reviews</h2>
          <p className="text-slate-500 text-sm mb-4">Your device ratings</p>
      ...
      <div className="mt-12 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-sm text-center">
        <p className="text-slate-500">Recent activity will appear here once you interact with devices or blogs.</p>
      </div>
    </div>
  );
}
