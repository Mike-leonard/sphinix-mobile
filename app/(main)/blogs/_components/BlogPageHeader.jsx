...
export default function BlogPageHeader({ totalCount }) {
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between bg-white dark:bg-[#1a2035] p-3 rounded-lg border border-slate-200 dark:border-slate-800 mb-6 gap-4 min-h-[64px]">
      <div>
        <h1  style={{fontSize: "var(--font-size-h1-blogs, var(--font-size-h1-default))"}} className="text-base font-bold text-slate-900 dark:text-white leading-tight">Blogs & News</h1>
        <p  style={{fontSize: "var(--font-size-p-form, var(--font-size-p-default))"}} className="text-xs text-slate-500 mt-0.5">Stay updated with the latest mobile trends.</p>
      </div>
