      ...
      {categories.map((category) => {
        ...
        return (
          <div key={category.key} className="flex flex-col">
            {/* Category Header */}
            <div className="bg-slate-50 dark:bg-slate-800/40 px-4 md:px-6 py-3 border-y border-slate-200 dark:border-slate-800 flex items-center gap-2 sticky top-[228px] md:top-[260px] z-20 backdrop-blur-sm">
