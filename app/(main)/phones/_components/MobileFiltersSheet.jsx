...
export default function MobileFiltersSheet({ 
  ...
  return (
    <Sheet open={showFilters} onOpenChange={setShowFilters}>
      <SheetContent side="bottom" className="max-h-[85vh] flex flex-col rounded-t-2xl p-6 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 shadow-xl">
