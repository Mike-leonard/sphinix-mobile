...
import GoogleIdsSection from './GoogleIdsSection';
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="space-y-6 max-w-2xl">
        <GoogleIdsSection settings={settings} handleChange={handleChange} />
        <VisitorStatsSection settings={settings} handleChange={handleChange} />
      </div>
