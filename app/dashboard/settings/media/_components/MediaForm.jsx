...
import CdnConfigurationSection from './CdnConfigurationSection';
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="space-y-8 max-w-2xl">
        <UploadLimitsSection settings={settings} handleChange={handleChange} />
        <ImageOptimizationSection settings={settings} handleChange={handleChange} />
