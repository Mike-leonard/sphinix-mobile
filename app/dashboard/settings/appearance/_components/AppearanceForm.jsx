...
import ThemeConfigurationSection from './ThemeConfigurationSection';
import LayoutLimitsSection from './LayoutLimitsSection';
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="space-y-6 max-w-2xl">
        <ThemeConfigurationSection settings={settings} handleChange={handleChange} />
        <LayoutLimitsSection settings={settings} handleNestedChange={handleNestedChange} />
      </div>
