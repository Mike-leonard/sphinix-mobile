...
import MaintenanceStatusBanner from './MaintenanceStatusBanner';
import MaintenanceToggleSection from './MaintenanceToggleSection';
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="space-y-6 max-w-2xl">
        <MaintenanceStatusBanner settings={settings} />
        <MaintenanceToggleSection settings={settings} handleChange={handleChange} />
      </div>
