      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden text-slate-100 ring-1 ring-purple-500/20 flex flex-col max-h-[90vh] relative">
        ...
        <div className="p-6 overflow-y-auto space-y-5 flex-1">
          ...
          <div className="px-3 py-2 bg-slate-950 border border-slate-800 rounded-xl text-xs text-slate-400 flex items-center gap-2">
            ...
            <a
              href={`https://www.google.com/search?q=${encodeURIComponent(queryInput)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs font-semibold text-slate-300 hover:text-white bg-slate-800/80 hover:bg-slate-800 border border-slate-700/80 px-3 py-1.5 rounded-lg shrink-0 transition-colors flex items-center gap-1.5 cursor-pointer"
              title={`Search "${queryInput}" on Google in a new browser tab`}
            >
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-3">
                  <Button
                    ...
                    variant="outline"
                    onClick={() => performSearch(queryInput)}
                    className="text-xs border-red-500/40 text-red-200 hover:bg-red-900/40"
                  >
                    Try Again
                  </Button>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-xs font-semibold text-blue-300 hover:text-blue-200 bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/30 px-3 py-1.5 rounded-lg flex items-center gap-1"
                  >
                    <Globe className="w-3.5 h-3.5 text-blue-400" />
            ...
            <div className="py-10 text-center flex flex-col items-center justify-center space-y-3 border border-dashed border-slate-800 rounded-xl bg-slate-950/30 p-6">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 max-w-sm mt-1">
                  Inspect or modify the query phrase above, then click <strong className="text-purple-300">Search</strong> to fetch live specifications or open in <strong className="text-blue-400">Google Search</strong>.
                </p>
              </div>
              <div className="flex items-center gap-2.5 mt-2">
                <Button
                  ...
                  className="bg-purple-600 hover:bg-purple-700 text-white rounded-xl text-xs font-bold px-5 py-2 shadow-md shadow-purple-600/30 gap-1.5 cursor-pointer"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white border border-slate-700 rounded-xl text-xs font-bold px-4 py-2 flex items-center gap-1.5 transition-colors cursor-pointer"
                >
